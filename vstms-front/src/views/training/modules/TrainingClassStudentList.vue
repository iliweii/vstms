<template>
  <a-card :bordered="false">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="学籍状态">
              <j-search-select-tag
                ...
                :triggerChange="true"
                placeholder="请选择状态"
                dict="training_class_student_status"
                :disabled="false"
              />
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      ...
      <!-- <a-button type="primary" icon="download" @click="handleExportXls('培训班学生关系')">导出</a-button>
      <a-upload
        name="file"
    ...
    <!-- 表单区域 -->
    <trainingClassStudent-modal ref="modalForm" @ok="modalFormOk"></trainingClassStudent-modal>
...
import TrainingClassStudentModal from './TrainingClassStudentModal'
import SelectUserModal from './SelectUserModal.vue'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'
import { putAction } from '@/api/manage'

export default {
  name: 'TrainingClassStudentList',
  mixins: [JeecgListMixin],
  components: {
    TrainingClassStudentModal,
    SelectUserModal,
  },
  props: {
    // 1. 对象数据
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          ellipsis: true,
          sorter: (a, b) => a.admissionDate - b.admissionDate,
        },
        {
          title: '结束日期',
          align: 'center',
      ...
      url: {
        list: '/training/trainingClassStudent/list',
        link: '/training/trainingClassStudent/link',
        delete: '/training/trainingClassStudent/delete',
        deleteBatch: '/training/trainingClassStudent/deleteBatch',
        exportXlsUrl: 'training/trainingClassStudent/exportXls',
        importExcelUrl: 'training/trainingClassStudent/importExcel',
      },
    }
  },
  computed: {
