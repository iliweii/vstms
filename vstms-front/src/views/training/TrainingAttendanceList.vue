        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="培训班编号">
              <a-input placeholder="请输入培训班编号" v-model="queryParam.classNo"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="学员用户名">
              <a-input placeholder="请输入学员用户名" v-model="queryParam.username"></a-input>
            </a-form-item>
          </a-col>
        <template v-if="toggleSearchStatus">
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="考勤日期">
              <a-input placeholder="请输入考勤日期" v-model="queryParam.atdDate"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="考勤状态 0出勤 1迟到 2旷课 3请假">
              <a-input placeholder="请输入考勤状态 0出勤 1迟到 2旷课 3请假" v-model="queryParam.atdStatus"></a-input>
            </a-form-item>
          </a-col>
          </template>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
