<template>
  ...
  >
    ...
    <a-alert :message="`${object.classNo_dictText}(${object.classNo}) 的开班典礼`" type="success" />
    ...
    <a-tabs :activeKey="activeKey" @tabClick="tabClick">
      ...
      <a-tab-pane key="2" tab="开班典礼记录">
        <opening-ceremony-record
          :object="object"
...
import OpeningCeremonyPlan from './OpeningCeremonyPlan.vue' // 开班典礼方案
import OpeningCeremonyRecord from './OpeningCeremonyRecord.vue' // 开班典礼记录

export default {
  name: 'OpenCeremonyBaseModal',
  components: {
    OpeningCeremonyPlan,
    OpeningCeremonyRecord,
  },
  data() {
    return {
      drawerWidth: '70%',
  ...
  methods: {
    ...
    handleChange(object) {
      getDictItemsFromCache('training_opening_ceremony_status')
