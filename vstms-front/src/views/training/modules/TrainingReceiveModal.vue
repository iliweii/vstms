  ...
  <a-drawer
    ...
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status" label="领取状态 0未领 1已领">
          <a-input placeholder="请输入领取状态 0未领 1已领" v-model="model.status" />
        </a-form-model-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/training/trainingReceive/add",
