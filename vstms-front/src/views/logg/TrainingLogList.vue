  ...
  <page-layout :title="title">
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button type="primary" icon="download" @click="handleExportXls('培训日志')">导出</a-button>
...
import TrainingLogModal from './modules/TrainingLogModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'

export default {
  name: 'TrainingLogList',
  ...
  data() {
    return {
      ...
      url: {
        list: '/training/trainingLog/list',
