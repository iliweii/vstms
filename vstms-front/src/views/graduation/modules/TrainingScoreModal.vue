  ...
  <a-drawer :title="title" :width="800" placement="right" :closable="false" @close="close" :visible="visible">
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="score" label="成绩">
          <a-input-number v-model="model.score" :max="100" :min="0" />
        </a-form-model-item>
      </a-form-model>
    </a-spin>
...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {},
      url: {
        add: '/training/trainingScore/add',
        edit: '/training/trainingScore/edit',
      },
    }
  },
  created() {},
