  ...
  <page-layout :title="title">
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button type="primary" icon="download" @click="handleExportXls('开班典礼')">导出</a-button>
        <a-upload
          name="file"
      ...
      <!-- 表单区域 -->
      <trainingOpeningCeremony-modal ref="modalForm" @ok="modalFormOk"></trainingOpeningCeremony-modal>
    </a-card>
  </page-layout>
</template>
...
import TrainingOpeningCeremonyModal from './modules/OpeningCeremonyBaseModal'
import { putAction } from '@/api/manage'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'

export default {
  name: 'TrainingOpeningCeremonyList',
  mixins: [JeecgListMixin],
  components: {
    PageLayout,
    TrainingOpeningCeremonyModal,
  },
  data() {
    return {
      description: '开班典礼管理页面',
      title: '开班典礼',
      // 表头
      columns: [
        {
      ...
      url: {
        list: '/training/trainingOpeningCeremony/list',
