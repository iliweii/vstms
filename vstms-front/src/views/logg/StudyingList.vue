  ...
  <page-layout :title="title">
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button type="primary" icon="download" @click="handleExportXls('学员日志')">导出</a-button>
...
import TrainingLogModal from './modules/StudyingModal'
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/training/trainingLog/list?flag=1&type=3',
