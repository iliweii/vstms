<template>
  <page-layout :title="title">
    <a-card :bordered="false">
      ...
      <!-- 表单区域 -->
      <trainingReceive-modal ref="modalForm" @ok="modalFormOk"></trainingReceive-modal>
    </a-card>
  </page-layout>
</template>
...
import TrainingReceiveModal from './modules/TrainingReceiveModal'
