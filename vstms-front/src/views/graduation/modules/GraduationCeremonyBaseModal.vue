<template>
  ...
  >
    ...
    <a-alert :message="`${object.classNo_dictText}(${object.classNo}) 的结业典礼`" type="success" />
...
import GraduationPlan from './GraduationCeremonyPlan.vue' // 结业典礼方案
import GraduationRecord from './GraduationCeremonyRecord.vue' // 结业典礼记录

export default {
  name: 'GraduationBaseModal',
  components: {
    GraduationPlan,
    GraduationRecord,
  },
