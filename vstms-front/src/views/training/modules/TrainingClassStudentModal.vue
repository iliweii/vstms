  ...
  <a-drawer :title="title" :width="800" placement="right" :closable="false" @close="close" :visible="visible">
    <a-spin :spinning="confirmLoading">
      <a-form-model ref="form" :model="model" :rules="validatorRules">
        ...
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="endDate" label="结束日期">
          <a-date-picker v-model="model.endDate" />
        </a-form-model-item>
        <a-form-model-item :labelCol="labelCol" :wrapperCol="wrapperCol" prop="status" label="学籍状态">
          <a-input placeholder="请学籍状态" v-model="model.status_dictText" disabled />
        </a-form-model-item>
      </a-form-model>
    </a-spin>
...
export default {
  name: 'TrainingClassStudentModal',
  data() {
    return {
      title: '操作',
      visible: false,
