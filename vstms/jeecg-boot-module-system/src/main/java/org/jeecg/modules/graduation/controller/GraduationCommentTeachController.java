...
public class GraduationCommentTeachController extends JeecgController<GraduationCommentTeach, IGraduationCommentTeachService> {
    ...
    public Result<?> queryPageList(GraduationCommentTeach graduationCommentTeach,
        ...
        IPage<GraduationCommentTeach> pageList = graduationCommentTeachService.page(page, queryWrapper);
