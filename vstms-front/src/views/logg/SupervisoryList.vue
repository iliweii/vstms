  ...
  <page-layout :title="title">
    <a-card :bordered="false">
      ...
      <div class="table-operator">
        ...
        <a-button type="primary" icon="download" @click="handleExportXls('督导日志')">导出</a-button>
...
import TrainingLogModal from './modules/SupervisoryModal'
import { JeecgListMixin } from '@/mixins/JeecgListMixin'

export default {
  name: 'SupervisoryList',
  ...
  data() {
    return {
      ...
      url: {
        list: '/training/trainingLog/list?flag=1&type=4',
